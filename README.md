...
Windows: `build.bat`
- If your user has non-ASCII characters in its path (e.g. cyrillics), create a new user with a purely-ASCII name and use `runas /user:<YOUR ALTERNATE USER'S NAME> build.bat`. *This is a bug in Scons, which is used by the build system.*
